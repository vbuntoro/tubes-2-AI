...
public class DriverWEKA {
    ...
    public DriverWEKA() throws Exception
    {
        ...
        algoList.add("SMO");
        outputText = "";
        homepath = "D:\\Project\\Web\\TubesAI\\src\\java\\tubesai\\weka\\";
...
//        }
    ...
    private void AddtoList() throws Exception
    {
        ...
        for (int i = 0; i < labeled.numInstances(); i++)
        {
            ...
            cd.setLabel(labeled.instance(i).stringValue(2));
    ...
    public void TrainDatabase() throws Exception{
        ...
        for(ClassifiedData cd : testlist)
        {
            if(cd.Changed())
            {
                String query1 = "INSERT INTO artikel('JUDUL','FULL_TEXT') VALUES('" +
